        ...
        <table>
            ...
            <tr>
                ...
                <td><div class="input-group">
                        ...
                        <input id="exercises" class="form-control" name="exercises" type="text" value="<?php echo $result{0}->exercises ?>" required>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td><div class="input-group">
                        ...
                        <input id="date" class="form-control" name="date" type="date" value="<?php echo $result{0}->homeworkDate ?>" required>
                    </div>
                </td>
            </tr>
        </table>
