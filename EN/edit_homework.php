    ...
    <form class="form" method="post" action="../scripts/update_homework.php">
        <table>
            ...
            <tr>
                ...
                <td><input id="lesson" name="lesson" type="text" value="<?php echo $result{0}->lessonName ?>" required></td>
            </tr>
            <tr>
                <td><label for="exercises">Exercises<a class="IsRequired">*</a>:</label></td>
                <td><input id="exercises" name="exercises" type="text" value="<?php echo $result{0}->exercises ?>" required></td>
            </tr>
            <tr>
                <td><label for="date">Date<a class="IsRequired">*</a>:</label></td>
                <td><input id="date" name="date" type="date" value="<?php echo $result{0}->homeworkDate ?>" style="width: 100% !important;" required></td>
            </tr>
        </table>
